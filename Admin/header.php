					...
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header">
						  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						   ...
						   <a class="navbar-brand" href="dashboard.php" >HOME<span class="glyphicon glyphicon-home" aria-hidden="true"></span>RENTING</a>
						</div>
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						 <ul class="nav navbar-nav">
						    ...
						    <?php if($Admin_Name ==true){
							 echo'<li class="act"><a href="logout.php">logout</a></li>';
							 echo'<li class="act"><a href="Action_room_information.php">Update</a></li>';
							 echo'<li class="act"><a href="dashboard.php">Dashboard</a></li>';
