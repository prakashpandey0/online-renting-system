...
if(isset($_POST['submit'])){
	...
	$path="home_renting/Images/".$filename;
...
if($error==""){
	...
	$query=mysqli_query($mycon,"INSERT INTO room_information (Enter_City, Price_Range, Room_Type,Size, Location, image, Description) VALUES('$Enter_City', '$Price_Range', '$Room_Type','$Size', '$Location', '$path', '$Description')"); 
		//var_dump($query);					
